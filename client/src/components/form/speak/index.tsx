      ...
      <section className="pb-[60px]">
        <div className="border p-5 rounded-[20px]">
          <div className="grid grid-cols-3 items-center gap-5">
            ...
            <Tipe title="Type" onChange={handleTipe} />
          ...
          <div className="grid grid-cols-6 pt-4 pb-5 gap-5">
            <div className="w-full flex flex-row justify-center items-center px-[23px] py-[18px] rounded-[10px] bg-[#E2F5FF] gap-[8px]">
              <input
                type="checkbox"
            ...
            <div className="col-span-5">
              <Link href="/speak/form/success">
                <button
                  className="btn w-full py-[18px] btn-lg bg-[#00A9FF] text-white"
