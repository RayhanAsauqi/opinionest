...
export default function Sidebar(props: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col sticky top-4">
      <Link
        className="bg-primary w-full px-[32px] py-[18px] rounded-[6px] text-white font-pop text-[16px] font-normal leading-normal"
        href="/speak/form"
      >
        Make a speak +
      </Link>
