    ...
    <div>
      ...
      <section className="container pt-[60px] ">
        <div className="grid grid-cols-3 px-[416px] items-center justify-center pb-[23px] ">
          <Link
            href="/"
            className="flex flex-row items-center bg-[#E2F5FF] w-[110px] h-[40px] rounded-[4px] p-[10px] text-primary font-pop text-[10px] font-normal leading-normal gap-[8px]"
          >
            <span>
              <ArrowLeft />
            </span>
          ...
          <h1 className="text-center text-black font-pop text-[24px] font-medium leading-[170%]">
            Succesful delivery
          </h1>
        </div>
      </section>
